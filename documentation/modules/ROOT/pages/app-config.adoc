...
[WARNING]
====
This exercise will unfortunately not work in the sandbox environment due to resource constraints. It is still worth reading through it and understanding how ConfigMaps can be used
====
