...
When pop-ups appear, `*confirm you want to open port 9000*` in the same way as before.
...
[NOTE]
====
If you have the following result on the 'Preview' window, please `*click on the refresh icon of this same window*`. The deployment can take up to a minute due to the resource constraints - have some patience!
