...
----
odo project create {USER_ID}-dev
----
...
[source,shell,subs="{markup-in-source}"]
----
 ✓  Project '{USER_ID}-dev' is ready for use
 ✓  New project created and now using project: {USER_ID}-dev
----
...
`*Select the 'Developer View' then your '{USER_ID}-dev'*` to be taken to the project overview page
