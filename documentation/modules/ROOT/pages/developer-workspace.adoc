...
[source,shell,subs="{markup-in-source}",role=copypaste]
----
odo project set ${CHE_WORKSPACE_NAMESPACE}-dev
----
...
on this page *Connect Your Workspace to Your OpenShift project*. Also make sure you check that your `*-dev*` project is selected.
