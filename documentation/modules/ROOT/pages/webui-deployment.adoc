...
image::node1.png[OpenShift - Node1 from Git, 700]
image::node2.png[OpenShift - Node2 from Git, 700]
...
The initial deployment might take 1-2 minutes because the UBI image has to be pulled first.
